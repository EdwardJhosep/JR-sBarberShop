...
<body>
    <nav class="navbar navbar-expand-lg navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="#" id="misReservas">
    ...
    <script>
        ...
        function obtenerInformacionCliente(id) {
            ...
            var url = 'http://lamhusu.blr.dom.my.id/api/mostrarcliente/' + id;
        ...
        function cerrarSesion() {
            var xhr = new XMLHttpRequest();
            var url = 'http://lamhusu.blr.dom.my.id/api/cliente/logout';
        ...
        // Evento para mis reservas (ejemplo, puedes ajustarlo según tu aplicación)
        misReservasBtn.addEventListener('click', function(event) {
            event.preventDefault();
            // Aquí implementar la lógica para mostrar las reservas del cliente
            alert('Implementar la funcionalidad de Mis Reservas');
        });
        ...
        // Llamar a obtenerInformacionCliente al cargar la página para mostrar automáticamente la foto del cliente
